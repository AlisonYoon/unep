...
<link href="../sub6/css/sub6_content2.css" type="text/css" rel="stylesheet">
...
?>
		<div id="write_form">
			...
			<div id="write_row1"><div class="col1"> Nickname </div><div class="col2"><?=$usernick?></div></div>
			<div class="write_line"></div>
			...
			<div class="write_line"></div>
			<div id="write_row4"><div class="col1"> File upload1   </div>
			                     <div class="col2"><input type="file" name="upfile[]"> * 5MB</div>
			</div>
			<div class="clear"></div>
...
?>
			<div class="write_line"></div>
			<div id="write_row5"><div class="col1"> File upload2  </div>
			                     <div class="col2"><input type="file" name="upfile[]">  * 5MB</div>
			</div>
...
?>
			<div class="write_line"></div>
			<div class="clear"></div>
			<div id="write_row6"><div class="col1"> File upload3  </div>
			                     <div class="col2"><input type="file" name="upfile[]">  * 5MB</div>
			</div>
...
?>
		...
		<div id="write_button">
		<a href="../sub6/sub6_2.php?table=<?=$table?>&page=<?=$page?>">List</a>&nbsp;
