...
<head>
<meta charset="utf-8">
<title>Chemicals & Waste::Mainstreaming</title>
...
<link href="css/sub6_content3.css" type="text/css" rel="stylesheet">
<link href="common/css/font-awesome.min.css" type="text/css" rel="stylesheet">   
...
body,td,th {
    ...
    #list_item2 a {font-size:2em; padding-bottom:3px; transition:all .2s ease; overflow-wrap: break-word;}
    ...
    .subjectarea {width:500px; height:120px; margin:10px 100px 20px 250px}
           ...
           <div class="container">
            ...
            include "common/leftnav.php" ?>
              ...
              <div id="content">
                ...
                <!--titleArea e-->
                <div class="divider">
                	<p>Mainstreaming Sound Management of Chemicals into Developments Planning and Strategies</p>
                </div>
                <!--divider e-->

                <div class="contentArea">
               
		<form  name="board_form" method="post" action="sub6_3.php?table=<?=$table?>&mode=search"> 
		<div id="list_search">
...
<?		
   for ($i=$start; $i<$start+$scale && $i < $total_record; $i++)                    
   {
	  ...
	  $item_date = substr($item_date, 0, 12);  
	 $item_subject = str_replace(" ", "&nbsp;", $row[subject]);
       ...
       if($img_name){
           ...
           $img_name = "../concert/data/default.jpg";
       }
?>          
...
<div id="list_item4"><span><?= $item_date ?></span><span><?= $item_hit ?></span></div>
                <div id="list_item2">
                    <img src="<?=$img_name ?>" width="200" height="100">
                    <div class="subjectarea">
                    <a href="../concert/view.php?table=<?=$table?>&num=<?=$item_num?>&page=<?=$page?>"><?= $item_subject ?></a>
                    </div>
                </div>
...
?>
			<div id="page_button">
				<div id="page_num"> <i class="fa fa-long-arrow-left" aria-hidden="true"></i> &nbsp;&nbsp;&nbsp;&nbsp; 
<?
   ...
   for ($i=1; $i<=$total_page; $i++)
   {
		...
		{ 
			echo "<a href='sub6_3.php?table=$table&page=$i'> $i </a>";
		}      
   }
?>			
			&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-long-arrow-right" aria-hidden="true"></i>
				...
				<div id="button">
					<a href="sub6_3.php?table=<?=$table?>&page=<?=$page?>">List</a>&nbsp;
<? 
	if($userid)
	{
?>
		<a href="../concert/write_form.php?table=<?=$table?>">Write</a>
<?
	}
?>
				</div>
